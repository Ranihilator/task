...
LDLIBSOPTIONS=`pkg-config --libs Qt5Qml` `pkg-config --libs breakpad` `pkg-config --libs breakpad-client` -ldl  
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chat
